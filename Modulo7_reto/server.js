...
const {init, getPib, buscar, agregar,eliminar }=require('./db.js')
...
app.get("/lista/:pib", async(req, res) => {
  let pib = req.params.pib;
  let respuesta=await buscar(pib)
  res.send(respuesta)
...
app.post("/agregar",async (req,res)=>{
  ...
  await agregar(nombre,pib_2019,pib_2020)
